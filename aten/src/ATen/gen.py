...
class FileManager(object):
    ...
    def write(self, filename, s, env=None):
        ...
        if isinstance(s, CodeTemplate):
            ...
            if filename == '/home/r.kintop/Documents/more_R_little_less_D/biblioteki_nn/TEMP_PYTORCH/build/aten/src/ATen/OPENCLByteType.cpp' :
                print 'RRRRRRRRRRRRRRRRRRRR'
                print filename
                print 'RRRRRRRRRRRRRRRRRRRR1'
                print env
                print 'RRRRRRRRRRRRRRRRRRRR2'
                print s.pattern
                print vars(s)
                print 'RRRRRRRRRRRRRRRRRRRR3'
            s = s.substitute(env)
